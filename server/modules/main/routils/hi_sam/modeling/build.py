...
from .efficient_sam.efficient_sam_decoder import \
    PromptEncoder as ePromptEncoder
from .efficient_sam.efficient_sam_encoder import \
    ImageEncoderViT as eImageEncoderViT
from .efficient_sam.two_way_transformer import \
    TwoWayTransformer as eTwoWayTransformer
...
def _build_sam(
    ...
    # checkpoint = "/ssd_scratch/sreevatsa/HiSAM/pretrained_checkpoint/hi_sam_l.pth"
    checkpoint = "/home/layout/models/hi_sam/hi_sam_l.pth"
    ...
    if checkpoint is not None:
        ...
        # if args.hier_det:
            ...
            if not contain_hi_decoder:
                ...
                with open(os.path.join('/home/layout/models/hi_sam', args.model_type+'_maskdecoder.pth'), "rb") as f:
        ...
        if model_type == 'vit_b':
            sam_path = os.path.join('/home/layout/models/hi_sam', 'sam_vit_b_01ec64.pth')
        elif model_type == 'vit_l':
            sam_path = os.path.join('/home/layout/models/hi_sam', 'sam_vit_l_0b3195.pth')
        elif model_type == 'vit_h':
            sam_path = os.path.join('/home/layout/models/hi_sam', 'sam_vit_h_4b8939.pth')
        ...
        if args.hier_det:
            ...
            for key in state_dict.keys():
                if 'hi_decoder' in key:
                    ...
                    break
            if not contain_hi_decoder:
                with open(os.path.join('/ssd_scratch/sreevatsa/HiSAM/pretrained_checkpoint', args.model_type+'_maskdecoder.pth'), "rb") as f_maskdecoder:
