    ...
    if checkpoint is not None:
        ...
        # if args.hier_det:
            ...
            if not contain_hi_decoder:
                ...
                with open(os.path.join('/ssd_scratch/sreevatsa/HiSAM/pretrained_checkpoint', args.model_type+'_maskdecoder.pth'), "rb") as f:
        ...
        if model_type == 'vit_b':
            sam_path = os.path.join('/ssd_scratch/sreevatsa/HiSAM/pretrained_checkpoint', 'sam_vit_b_01ec64.pth')
        elif model_type == 'vit_l':
            sam_path = os.path.join('/ssd_scratch/sreevatsa/HiSAM/pretrained_checkpoint', 'sam_vit_l_0b3195.pth')
        elif model_type == 'vit_h':
            sam_path = os.path.join('/ssd_scratch/sreevatsa/HiSAM/pretrained_checkpoint', 'sam_vit_h_4b8939.pth')
